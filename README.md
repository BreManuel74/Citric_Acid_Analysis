...
4. across_cohort_lick.py and lick_analysis.py are the main analysis scripts for the characterization cohorts' lick data. These scripts work with lick counts, frontloading metrics, fecal count, and lick bout counts.
